...
')
     ...
     */ 
         ...
         *
         * @param \Farm|int $farm
         * @return \App\Services\IFarmService 
         * @static 
         */ 
        public static function forFarm($farm)
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->forFarm($farm);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getFarmModelInstance()
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->getFarmModelInstance();
        }
                    /**
         * 
         *
         * @param \App\Services\User|int $user
         * @return boolean 
         * @static 
         */ 
        public static function assignLocalAdmin($user)
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->assignLocalAdmin($user);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function removeLocalAdmin()
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->removeLocalAdmin();
        }
                    /**
         * 
         *
         ...
         * @param \App\Services\UploadedFile $image
         * @static 
         */ 
        public static function create($name, $city, $area, $address, $region, $established_at, $closed_at, $image)
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->create($name, $city, $area, $address, $region, $established_at, $closed_at, $image);
        }
     ...
     */ 
         ...
         *
         * @param \Post|int $post
         * @return \App\Services\IPostService 
         * @static 
         */ 
        public static function forPost($post)
        {
                        /** @var \App\Services\PostService $instance */
                        return $instance->forPost($post);
        }
                    /**
         * 
         *
         ...
         * @param \App\Services\User|int $op
         * @return bool 
         * @static 
         */ 
        public static function create($title, $body, $image, $farm_id, $op)
        {
                        /** @var \App\Services\PostService $instance */
                        return $instance->create($title, $body, $image, $farm_id, $op);
        }
     ...
     */ 
         ...
         *
         * @param \Cow|int $cow
         * @return \App\Services\ICowService 
         * @static 
         */ 
        public static function forCow($cow)
        {
                        /** @var \App\Services\CowService $instance */
                        return $instance->forCow($cow);
        }
                    /**
         * 
         *
         * @param string $name
         * @param \App\Services\Breed|int $breed_id
         ...
         * @static 
         */ 
        public static function create($name, $breed_id, $farm_id, $gender, $image, $description, $dob, $extras)
        {
                        /** @var \App\Services\CowService $instance */
                        return $instance->create($name, $breed_id, $farm_id, $gender, $image, $description, $dob, $extras);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function update($name, $breed_id, $farm_id, $gender, $image, $description, $dob, $extras)
        {
                        /** @var \App\Services\CowService $instance */
                        return $instance->update($name, $breed_id, $farm_id, $gender, $image, $description, $dob, $extras);
        }
...
namespace  { 
            ...
            class Post extends \App\Facades\Post {}
