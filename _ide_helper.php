...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function assignLocalAdmin($farm_id, $user_id)
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->assignLocalAdmin($farm_id, $user_id);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function removeLocalAdmin($farm_id)
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->removeLocalAdmin($farm_id);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function create($name, $location, $owner_id, $establish_date, $ladmin_id)
        {
                        /** @var \App\Services\FarmService $instance */
                        return $instance->create($name, $location, $owner_id, $establish_date, $ladmin_id);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($name, $breed_id, $farm_id, $gender, $description, $dob, $type)
        {
                        /** @var \App\Services\CowService $instance */
                        return $instance->create($name, $breed_id, $farm_id, $gender, $description, $dob, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function update($cow_id, $name, $breed_id, $farm_id, $gender, $description, $dob, $type)
        {
                        /** @var \App\Services\CowService $instance */
                        return $instance->update($cow_id, $name, $breed_id, $farm_id, $gender, $description, $dob, $type);
        }
