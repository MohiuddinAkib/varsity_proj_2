...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function update($cow_id, $breed_id, $farm_id, $gender, $description, $dob, $type)
        {
                        /** @var \App\Services\CowService $instance */
                        return $instance->update($cow_id, $breed_id, $farm_id, $gender, $description, $dob, $type);
        }
